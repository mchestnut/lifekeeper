<template>
  <svg class="c-card-button-poison" viewBox="0 0 109 51">
    <defs>
    ...
    <path class="c-card-button-poison__stroke" :style="stroke" transform="translate(1 1)" d="M106.06,27l-7.6,17.23a7,7,0,0,1-6.38,4.16H14.57a7,7,0,0,1-6.38-4.16L.59,27a7,7,0,0,1,0-5.62L8.19,4.16A7,7,0,0,1,14.57,0H92.08a7,7,0,0,1,6.38,4.16l7.6,17.21A7,7,0,0,1,106.06,27Z"/>
    <path class="c-card-button-poison__background" :style="background" transform="translate(1 1)" d="M92.08,44.4H14.57a3,3,0,0,1-2.72-1.77L4.25,25.4a3,3,0,0,1,0-2.4l7.6-17.23A3,3,0,0,1,14.57,4H92.08A3,3,0,0,1,94.8,5.77L102.4,23a3,3,0,0,1,0,2.4L94.8,42.62A3,3,0,0,1,92.08,44.4Z"/>
